...
func (a *App) initHandlers() {
	a.handlers = &Handlers{
		...
		WebSocket:      websocket.NewWebSocketHandler(a.services.Chat, a.services.Auth, a.resources, a.logger),
		NotificationWS: websocket.NewNotificationWebSocketHandler(a.services.Auth, a.resources, a.logger),
