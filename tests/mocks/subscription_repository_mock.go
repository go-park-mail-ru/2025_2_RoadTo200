...
func (mr *MockSubscriptionRepositoryMockRecorder) Delete(ctx, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSubscriptionRepositoryMockRecorder) GetActiveSubscription(ctx, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSubscriptionRepositoryMockRecorder) GetByUserID(ctx, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
