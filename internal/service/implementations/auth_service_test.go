...
func TestAuthService_Register_Success(t *testing.T) {
	...
	// Вызов метода
	user, session, err := service.Register(ctx, email, password, password)
...
func TestAuthService_Register_UserAlreadyExists(t *testing.T) {
	...
	// Вызов метода
	user, session, err := service.Register(ctx, email, "123456", "123456")
...
func TestAuthService_Register_PasswordMismatch(t *testing.T) {
	...
	ctx := context.Background()
	user, session, err := service.Register(ctx, "test@example.com", "123456", "different")
...
func TestAuthService_Register_ShortPassword(t *testing.T) {
	...
	ctx := context.Background()
	user, session, err := service.Register(ctx, "test@example.com", "123", "123")
...
func TestAuthService_Login_InvalidCredentials(t *testing.T) {
	...
	// Вызов метода
	user, session, err := service.Login(ctx, email, "wrongpassword")
...
// 	service := service.NewAuthService(mockUserRepo, mockSessionRepo, mocks.NewMockLogger())
